...
const config = {
  ...
  tagline: 'Comprehensive textbook on Physical AI and Humanoid Robotics with RAG-powered chatbot',
  ...
  baseUrl: '/unified-book-project/',

  // GitHub pages deployment config.
  organizationName: 'your-organization', // Usually your GitHub org/user name.
  projectName: 'unified-book-project', // Usually your repo name.
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/your-username/unified-book-project',
            label: 'GitHub',
            position: 'right',
          },
        ],
  ...
  // Add custom scripts for production
  scripts: [
    {
