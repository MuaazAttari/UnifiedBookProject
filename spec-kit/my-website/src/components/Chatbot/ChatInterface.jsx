...
/**
 * A chat interface component for Docusaurus that allows users to ask questions
 * about textbook content with context awareness.
 */
const ChatInterface = ({ contextType = 'full_book', selectedText = null, chapterTitle = null }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const requestBody = {
        ...
        user_id: null, // In a real implementation, you'd get this from auth
        max_context_length: 2000,
        top_k: 5,
        ...(currentContext === 'selected_text' && displayedSelectedText && { selected_text: displayedSelectedText })
      };

      // Call the backend API - using relative path for Docusaurus
      ...
      const botMessage = {
        ...
        confidencePercentage: data.confidence_percentage || Math.round((data.confidence || 0) * 100)
      };
